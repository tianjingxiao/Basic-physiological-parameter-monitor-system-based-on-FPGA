...
set_property PACKAGE_PIN W2 [get_ports xz]					
	set_property IOSTANDARD LVCMOS33 [get_ports xz]
set_property PACKAGE_PIN U1 [get_ports nRst]					
	set_property IOSTANDARD LVCMOS33 [get_ports nRst]
set_property PACKAGE_PIN T1 [get_ports En]					
	set_property IOSTANDARD LVCMOS33 [get_ports En]
set_property PACKAGE_PIN R2 [get_ports en0]					
